...
//Input tgl(string, Y-m-d), jml(int) => jml untuk penjumlahan brp bulan
//Output asanoer_edate string, Y-m-d
//
//Pembuat fungsi, ASANOER.com

if (!function_exists('asanoer_edate')){
	function asanoer_edate($tgl='1990-10-27', $jml=1){
